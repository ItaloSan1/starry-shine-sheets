    ...
    <div className="pb-20 lg:pb-0">
      <div className="relative bg-secondary text-foreground py-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          <h1 className="text-xl md:text-3xl font-bold text-foreground">Frequently Asked Questions</h1>
          <p className="text-foreground/70 mt-2 text-sm md:text-base">Common questions about buying used auto parts in Edmonton.</p>
        </div>
      </div>
