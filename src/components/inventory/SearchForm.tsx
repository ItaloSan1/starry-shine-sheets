    ...
    <form onSubmit={handleSubmit} className="bg-card border border-border rounded-lg p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 mb-3">
        <select
          ...
          className="w-full px-3 py-2.5 rounded-md border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-accent"
        >
        ...
        <select
          ...
          className="w-full px-3 py-2.5 rounded-md border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-accent disabled:opacity-50"
        >
        ...
        <button
          type="submit"
          className="w-full bg-accent text-accent-foreground px-4 py-2.5 rounded-md font-bold text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
        >
